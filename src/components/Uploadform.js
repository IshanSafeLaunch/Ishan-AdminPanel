...
//       const account = accounts; // Use the accounts prop directly
//       console.log("Sahil",account);
//       const contract = new web3.eth.Contract(contractABI, contractAddress);

//       const contributorsAndAmountsArray = contributorsAndAmounts.split(',').map(entry => entry.trim()); // Split input by comma and trim whitespace
//       const contributors = [];
//       const amounts = [];
